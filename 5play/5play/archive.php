    ...
    <div class="page-head-cat">
        <div class="wrp-min">
            <div class="head-cat-title">
                <h1 class="title"><?php printf( __( '%s', 'moddroid' ), '<b>' . single_cat_title( '', false ) . '</b>' ); ?></h1>
            ...
            <div class="cat-menu-collapse collapse" id="collapse-menu">
                <div class="cat-menu-list">
                    <ul>
                        ...
                        if ( $cats ) {
                            //echo '<li onchange="self.location.href=a[selectedIndex].value" class="select">';
                            //echo '<li class="catalog-genres-item">All Games in ' . single_cat_title( '', false ) . '</li>';
                            foreach ($cats as $cat) {
                                echo '<li class="catalog-genres-item"><a href="'. $cat->slug .'">'. $cat->cat_name .'</a></li>';
                            }
                            //echo '</li>'; 
                        }
                        ?>
