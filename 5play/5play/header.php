...
?>
<!DOCTYPE html>
<html prefix="og: http://ogp.me/ns#" <?php if($rtl_on) { ?> dir="rtl" lang="<?php echo $rtl_lang; ?>"<?php } else{ ?><?php language_attributes(); ?><?php } ?> id="h" class="load" style="margin-top: 0px !important;">
<head>
<meta charset="utf-8">
                    ...
                    <div class="dropdown userpanel">
                        ...
                        <div class="dropdown-menu dropdown-form dropdown-menu-right" aria-labelledby="login_drop" style="display:none;">
                            <div class="login-pane__info">
                                ...
                                <div class="title"><a > <?php  global $current_user; get_currentuserinfo(); echo $current_user->display_name ; ?></div>
                            </div>
