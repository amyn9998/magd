...
<div class="page-cdn">
<?php global $opt_themes; if($opt_themes['ex_themes_rtl_activate_']) { ?>
 <div class="page-cdn-back"><a href="<?php the_permalink() ?>"><?php global $opt_themes; if($opt_themes['exthemes_content_Back_main']) { ?><?php echo $opt_themes['exthemes_content_Back_main']; ?><?php } ?><i class="s-button c-icon"><svg width="24" height="24"><?php global $opt_themes; if($opt_themes['ex_themes_rtl_activate_']) { ?>
<use xlink:href="#i__arrowright"></use>
<?php } else { ?>
<use xlink:href="#i__arrowleft"></use>
<?php } ?></svg></i></a></div>
<?php } else { ?>
<div class="page-cdn-back"><a href="<?php the_permalink() ?>"><i class="s-button c-icon"><svg width="24" height="24"><?php global $opt_themes; if($opt_themes['ex_themes_rtl_activate_']) { ?>
<use xlink:href="#i__arrowright"></use>
<?php } else { ?>
<use xlink:href="#i__arrowleft"></use>
        ...
        <div id='dle-content'>
            <div class="download-cdn">
                ...
                <div class="download-btn-group" style="display:none;">
					...
					<a id="no-link" href="<?php echo $urlsx; ?>"><input type="button" value="<?php global $opt_themes; if($opt_themes['exthemes_apk_info_Download']) { ?><?php echo $opt_themes['exthemes_apk_info_Download']; ?><?php } ?>" class="btn s-button btn-lg btn-block"><svg style="display:none;" width="24" height="24"><use xlink:href="#i__getapp"></use></svg></a>
					</div>                    
                </div>
...
<svg aria-hidden="true" style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
        ...
        <symbol id="i__arrowleft" viewBox="0 0 24 24">
            <path fill="var(--colorsvg)" d="M19 11H7.83l4.88-4.88c.39-.39.39-1.03 0-1.42-.39-.39-1.02-.39-1.41 0l-6.59 6.59c-.39.39-.39 1.02 0 1.41l6.59 6.59c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L7.83 13H19c.55 0 1-.45 1-1s-.45-1-1-1z" />
        </symbol>
        <symbol id="i__arrowright" viewBox="0 0 24 24">
            <path fill="var(--colorsvg)" d="M5 13h11.17l-4.88 4.88c-.39.39-.39 1.03 0 1.42.39.39 1.02.39 1.41 0l6.59-6.59c.39-.39.39-1.02 0-1.41l-6.58-6.6c-.39-.39-1.02-.39-1.41 0-.39.39-.39 1.02 0 1.41L16.17 11H5c-.55 0-1 .45-1 1s.45 1 1 1z" />
        </symbol>
