        ...
        <div id='dle-content'>
            <div class="download-cdn">
                <ul class="download-cdn-main">
                    ...
                    <li class="cdn-meta"><svg width="24" height="24"><use xlink:href="#i__vers"></use></svg><span class="ww-break-word"><?php if (get_post_meta( $post->ID, 'wp_rated_GP', true )) { ?><?php echo esc_html( get_post_meta( $post->ID, 'wp_rated_GP', true ) ); ?><?php } else { ?>4.5<?php } ?></span></li>
                </ul>
