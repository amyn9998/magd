...
<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/assets/css/core.styles.css" as="style">
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/cores.styles.css" type="text/css" rel="stylesheet">
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/form.styles.css" type="text/css" rel="stylesheet">
</head>
<body>
<div class="toolbar">
...
<h1 class="title"><?php echo $opt_themes['ex_themes_homes_titles_']; ?></h1>
</div>
