<?php 
global $opt_themes; 
$homes_titles		=	$opt_themes['ex_themes_homes_titles_'];
$main_banner		=	$opt_themes['ex_themes_page_head_main_banner']['url'];
$latest_post_on		=	$opt_themes['latest_post_homes'];
$latest_post_title	=	$opt_themes['exthemes_latest_post_index'];
get_header(); ?>
<div class="page-head-main">
	<h1 class="title" style='text-transform: capitalize;'><?php echo $homes_titles ?></h1>
	<img width="1408" height="276" src="<?php echo $main_banner; ?>" >
</div>

<?php if( !function_exists('dynamic_sidebar') || !dynamic_sidebar('recommend-homes') ) : endif; 
if($latest_post_on) { ?>
<section class="wrp section">
	...
	<?php endif; get_template_part('template/navy'); ?>
	</section>
<?php } 
