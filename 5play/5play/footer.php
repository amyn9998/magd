        ...
        <div class="wrp-min">
            <div class="footer-panel">
                <a class="logotype scrollup" style="display:none;" href="#" title="<?php echo get_option("blogname") ?>">
                    ...
                    <i class="logo-icon"><img src="<?php global $opt_themes; if($fav_on) { ?><?php echo $fav; ?><?php } else { ?><?php echo get_template_directory_uri(); ?>/assets/img/logo_footer.png<?php } ?>"  width="36" height="36"></i>
				</a>
...
<footer class="footer">
        <div class="wrp-min">
            <div class="footer-panel">
                <a class="logotype scrollup" style="display:none;" href="#" title="<?php echo get_option("blogname") ?>">
                    <span class="sr-only"><?php echo get_option("blogname") ?></span>
                    <i class="logo-icon"><img src="<?php if($fav_on) { ?><?php echo $fav; ?><?php } else { ?><?php echo get_template_directory_uri(); ?>/assets/img/logo_footer.png<?php } ?>"  width="36" height="36"></i>
				</a>
                <a class="upper scrollup" href="#" title="<?php echo get_option("blogname") ?>"><span class="sr-only"><?php if($scroll_up) { ?><?php echo $scroll_up; ?><?php } ?></span><svg width="24" height="24"><use xlink:href="#i__scrollup"></use></svg></a>
                <div class="footer-cont">
                    <div class="copyright"><?php ex_themes_copyright_(); ?></div>
